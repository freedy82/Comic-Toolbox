...
pylupdate5 main_window.py about_window.py crop_window.py crop_frame.py image_filter_window.py help_window.py bookmark_window.py -ts ../languages/en.ts
qt5-tools lrelease ../languages/en.ts ../languages/en.qm

pylupdate5 main_window.py about_window.py crop_window.py crop_frame.py image_filter_window.py help_window.py bookmark_window.py -ts ../languages/zh_Hant.ts
qt5-tools lrelease ../languages/zh_Hant.ts ../languages/zh_Hant_extra.ts  -qm ../languages/zh_Hant.qm

pylupdate5 main_window.py about_window.py crop_window.py crop_frame.py image_filter_window.py help_window.py bookmark_window.py -ts ../languages/zh_Hans.ts
